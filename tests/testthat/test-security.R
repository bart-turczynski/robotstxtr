...
#
# `oysteR::expect_secure("robotstxtr")` resolves the installed DESCRIPTION and
# audits robotstxtr's declared dependencies against the Sonatype OSS Index. It
...
# other context (local runs, the verify/full-check/sanitizer suites) it skips
...
test_that("declared dependencies have no known OSS Index vulnerabilities", {
  ...
  oysteR::expect_secure("robotstxtr")
})
