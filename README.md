...
availability, and the final URL decision. Unsupported RFC 9309, Yandex,
or Bing matchers return `capability_unavailable` rather than silently
falling back to Google. See [the engine-aware
